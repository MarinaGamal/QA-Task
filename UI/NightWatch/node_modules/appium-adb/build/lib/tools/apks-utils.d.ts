...
export type InstallMultipleApksOptions = {
    /**
     * [20000] - The number of milliseconds to wait until
...
declare namespace apksUtilsMethods {
     ...
     * executing it
     */
    function execBundletool(args: string[], errorMsg: string): string;
    /**
     ...
     */
    function getDeviceSpec(specLocation: string): string;
    /**
     ...
     */
    function installMultipleApks(apkPathsToInstall: string[], options?: any): Promise<any>;
    /**
     ...
     */
    function extractBaseApk(apks: string): string;
    /**
     ...
     * @throws {Error} If there was an error while extracting/finding the file
     */
    function extractLanguageApk(apks: string, language?: string | null): string;
